...
公開には利用者の明示依頼が必要です。2026-09-05に最新版をGitHubへpushする依頼を受領し、その対象commit・tree・配布assetのhashを公開記録へ結び付けます。 Platform expansion and live quality observation are nonblocking beta work under `docs/RELEASE-DECISIONS.md`.
...
- [ ] Record the publication request against the final tracked-file list, audit report, tests and release hashes; present the resulting candidate before push.
